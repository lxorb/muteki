...
### TLE PROTECTION ###
TLE_SKIP_TURNS: int = 5
SAVER_TLE_RATIO: float = 0.2
TLE_SAVER_CANDIDATE_DIST_SQ: int = 4
...
BOTS_ARE_URGENT: bool = False
TURRET_UNFED_SELF_DESTRUCT_ROUNDS: int = 500
...
FOLLOW_ENEMY_BB_MAX_ACTION_DISTANCE = 1
YEET_STUCK_OSCILLATION_ROUNDS = 10
...
try:
    ...
    if exclude_module_dir is not None:
        ...
        FOLLOW_ENEMY_BB_MAX_ACTION_DISTANCE = getattr(
            exclude,
